...
def GetKmeansClusteringOutputs (InputData,NumGrpDays,NClusters, PeakDayinCluster, LoadWeight):
...
#        print(PossibleNClusters[j])
        ...
        for k in range(len(SelectPeakDayinCluster)):
            ...
            =GetKmeansClusteringOutputs(AnnualTSeries,PossibleNumGrpDays[i],PossibleNClusters[j],
...
for k in range(3):  # three load profiles
 ...
 plt.savefig('LoadError_'+'MaxGrpDays_' + str(PossibleNumGrpDays[-1]) + 'MaxNumClusters_' + str(PossibleNClusters[-1]) +'Peakhr_'+ str(ForcePeakday) +'.png',bbox_inches="tight")
...
for i in range(3):
 ...
 plt.tick_params(axis='y',labelsize =fontsizeval)
 plt.tick_params(axis='x',labelsize =fontsizeval)
plt.savefig('Load_DurationCurve_'+'GrpDays_' + str(NumGrpDays) + 'NumClusters_' + str(NClusters) +'Peakhr_'+ str(ForcePeakday) +'.png',bbox_inches="tight")
...
for i in range(2):
 ...
 plt.tick_params(axis='y',labelsize =fontsizeval)
 plt.tick_params(axis='x',labelsize =fontsizeval)
plt.savefig('SolarCFCurve_'+'GrpDays_' + str(NumGrpDays) + 'NumClusters_' + str(NClusters) +'Peakhr_'+ str(ForcePeakday) +'.png',bbox_inches="tight")
...
ClusteringOutput = pd.read_csv('AZ_' +
                   'NumGrpDays_'+ str(NumGrpDays) +'_NClusters_' + str(NClusters) +
...
LoadSeries['Load_MW_z4'] = ClusteringOutput['Load_MW_z4'][0:Nhours] 
LoadSeries['Load_MW_z5'] = ClusteringOutput['Load_MW_z5'][0:Nhours]
LoadSeries['Load_MW_z6'] = ClusteringOutput['Load_MW_z6'][0:Nhours]
LoadSeries['Load_MW_z7'] = ClusteringOutput['Load_MW_z7'][0:Nhours] 


LoadSeries.to_csv('Load_data.csv',index=False)
